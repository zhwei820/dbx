...
export default withEnglishFallback({
  ...
  connection: {
    ...
    replaceEndpointTitle: "接続情報を置き換え",
    replaceEndpointDescription: "mysql系クライアントコマンドまたは接続URLを貼り付けてください。ホスト・ポート・ユーザー名・パスワード・データベースが置き換わります。接続名、ドライバー、SSHトンネルなどの詳細設定はそのままです。コマンドに含まれないユーザー名やパスワードは既存の設定を引き継ぎます。",
    replaceEndpointPlaceholder: "mycli -hlocalhost -P32883 -uroot -p123456 tms",
    replaceEndpointApply: "置き換えて再接続",
    replaceEndpointApplied: "接続先を {target} に変更しました",
    replaceEndpointEmpty: "クライアントコマンドまたは接続URLを入力してください",
    replaceEndpointTypeMismatch: "これは {label} の接続文字列です。この接続を置き換えられるのはmysql系の接続文字列のみです。",
    mode: "接続モード",
    modeForm: "フォーム",
  ...
  contextMenu: {
    ...
    replaceConnectionEndpoint: "接続情報を置き換え",
    ...
    copyName: "名前をコピー",
    copyConnectionDetails: "接続情報をコピー",
    connectionAddress: "アドレス",
    connectionPort: "ポート",
    connectionUsername: "ユーザー名",
