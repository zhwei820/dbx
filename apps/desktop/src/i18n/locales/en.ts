...
export default {
  ...
  connection: {
    ...
    replaceEndpointTitle: "Replace connection info",
    replaceEndpointDescription: "Paste a mysql-family client command or connection URL. Host, port, username, password and database are replaced; the connection name, driver, SSH tunnel and other advanced settings stay as they are. An omitted user or password keeps the configured one.",
    replaceEndpointPlaceholder: "mycli -hlocalhost -P32883 -uroot -p123456 tms",
    replaceEndpointApply: "Replace and reconnect",
    replaceEndpointApplied: "Connection now points at {target}",
    replaceEndpointEmpty: "Enter a client command or connection URL",
    replaceEndpointTypeMismatch: "That is a {label} connection string; only a mysql-family one can replace this connection.",
  ...
  contextMenu: {
    ...
    replaceConnectionEndpoint: "Replace Connection Info",
    ...
    copyName: "Copy Name",
    copyConnectionDetails: "Copy Connection Details",
