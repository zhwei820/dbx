...
export default withEnglishFallback({
  ...
  connection: {
    ...
    replaceEndpointEmpty: "Introduce un comando de cliente o una URL de conexión",
    replaceEndpointTypeMismatch: "Esa es una cadena de conexión de {label}; solo una de la familia mysql puede reemplazar esta conexión.",
  ...
  contextMenu: {
    ...
    replaceConnectionEndpoint: "Reemplazar datos de conexión",
    ...
    copyConnectionDetails: "Copiar datos de conexión",
    connectionAddress: "Dirección",
    connectionPort: "Puerto",
    connectionUsername: "Usuario",
    connectionPassword: "Contraseña",
    name: "Nombre",
