...
export default withEnglishFallback({
  ...
  connection: {
    ...
    replaceEndpointTitle: "替換連線資訊",
    replaceEndpointDescription: "貼上 mysql 系用戶端命令或連線 URL。主機、連接埠、使用者名稱、密碼與資料庫會被替換；連線名稱、驅動、SSH 通道等進階設定維持不變。命令中未給出的使用者名稱或密碼沿用原有設定。",
    replaceEndpointPlaceholder: "mycli -hlocalhost -P32883 -uroot -p123456 tms",
    replaceEndpointApply: "替換並重新連線",
    replaceEndpointApplied: "連線已指向 {target}",
    replaceEndpointEmpty: "請輸入用戶端命令或連線 URL",
    replaceEndpointTypeMismatch: "這是 {label} 的連線字串，只有 mysql 系的連線字串才能替換此連線。",
    mode: "連線方式",
    modeForm: "表單",
  ...
  contextMenu: {
    ...
    editConnection: "編輯連線",
    replaceConnectionEndpoint: "替換連線資訊",
    ...
    copyName: "複製名稱",
    copyConnectionDetails: "複製連線資訊",
    connectionAddress: "位址",
    connectionPort: "連接埠",
    connectionUsername: "使用者名稱",
