...
export default withEnglishFallback({
  ...
  connection: {
    ...
    replaceEndpointEmpty: "Informe um comando de cliente ou uma URL de conexão",
    replaceEndpointTypeMismatch: "Esta é uma string de conexão {label}; apenas uma da família mysql pode substituir esta conexão.",
  ...
  contextMenu: {
    ...
    replaceConnectionEndpoint: "Substituir dados da conexão",
    ...
    copyConnectionDetails: "Copiar dados da conexão",
    connectionAddress: "Endereço",
    connectionPort: "Porta",
    connectionUsername: "Nome de usuário",
