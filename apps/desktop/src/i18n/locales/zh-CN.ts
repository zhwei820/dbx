...
export default withEnglishFallback({
  ...
  connection: {
    ...
    replaceEndpointTitle: "替换连接信息",
    replaceEndpointDescription: "粘贴 mysql 系客户端命令或连接 URL。主机、端口、用户名、密码和数据库会被替换；连接名称、驱动、SSH 隧道等高级设置保持不变。命令中未给出的用户名或密码沿用原有配置。",
    replaceEndpointPlaceholder: "mycli -hlocalhost -P32883 -uroot -p123456 tms",
    replaceEndpointApply: "替换并重新连接",
    replaceEndpointApplied: "连接已指向 {target}",
    replaceEndpointEmpty: "请输入客户端命令或连接 URL",
    replaceEndpointTypeMismatch: "这是 {label} 的连接串，只有 mysql 系的连接串才能替换该连接。",
    mode: "连接方式",
    modeForm: "表单",
  ...
  contextMenu: {
    ...
    editConnection: "编辑连接",
    replaceConnectionEndpoint: "替换连接信息",
    ...
    copyName: "复制名称",
    copyConnectionDetails: "复制连接信息",
    connectionAddress: "地址",
    connectionPort: "端口",
